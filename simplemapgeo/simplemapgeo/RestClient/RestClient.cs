...
namespace Plugin.RestClient
{
    ...
    {
        // a classic Asp.net Web API project with a Controler that contains CRUD For Geolocation Model
        private const string WebServiceUrl = "http://geolocationbackend.azurewebsites.net/api/Geolocations/";
